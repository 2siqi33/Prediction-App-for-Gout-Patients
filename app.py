...
# AKI概率预测函数，应用Sigmoid函数转换
def predict_aki_probability(features):
    aki_prob = aki_model.predict(features)  # 获得原始预测值
    aki_prob_sigmoid = sigmoid(aki_prob)    # 应用Sigmoid函数转换为概率
    return aki_prob_sigmoid[0]  # 返回第一个样本的概率
...
# User selects which content to display
    ...
    # Feature input
        ...
        if prediction_type == "AKI Prediction":
            ...
            Glucocorticoid_encoded = Glucocorticoid_mapping[Glucocorticoid]
